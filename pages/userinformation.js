      ...
      <div className="px-10 py-10 flex gap-5 divide-x-2 h-[70vh] bg-gray-200">
        ...
        <div className="pl-5 flex-1">
          ...
          <div className="grid grid-cols-3 gap-5">
            <div className="border border-gray-300 h-[100px] ">Box 1</div>
            <div className="border border-gray-300  h-[100px] ">Box 2</div>
            <div className="border border-gray-300 h-[100px] ">Box 3</div>
            <div className="border border-gray-300 h-[100px] ">Box 4</div>
            <div className="border border-gray-300 h-[100px] ">Box 5</div>
          </div>
        </div>
      </div>
